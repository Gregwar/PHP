...
INSERT INTO `films` (`id`, `annee`, `description`, `nom`, `genre_id`) VALUES
(1, '1997', 'Au XXIII siècle, dans un univers étrange et coloré, ou tout espoir de survie est impossible sans la découverte du cinquième élément, un héros affronte le mal pour sauver l''humanité. ', 'Le Cinquième élément', 1),
(2, '2000', 'Cole Sear, garconnet de huit ans est hanté par un terrible secret. Son imaginaire est visité par des esprits menaçants. Trop jeune pour comprendre le pourquoi de ces apparitions et traumatisé par ces pouvoirs paranormaux, Cole s''enferme dans une peur maladive et ne veut reveler à personne la cause de son enfermement, à l''exception d''un psychologue pour enfants. La recherche d''une explication rationnelle guidera l''enfant et le thérapeute vers une vérité foudroyante et inexplicable. ', 'Sixième Sens', 2),
(3, '2001', 'Une nouvelle année scolaire commence pour Trevor McKinney, un garçon de douze ans, une année qui ne ressemblera à aucune autre et changera peut-être la vie de milliers d''hommes. Le jour de la rentrée, Trevor reçoit de la part de son professeur Eugene Simonet un sujet de devoir pour le moins inhabituel : trouver une solution pour rendre le monde meilleur et la mettre en pratique.\r\n\r\nPlus mûr, plus sensible que ses camarades, Trevor prend très au sérieux ce devoir. Il suggère d''aider de façon désintéressée trois personnes qui deviendront ses obligées, et chacune d''entre elles devra passer le relais à trois inconnus qui en feront de même à leur tour.\r\n\r\nOn ne peut pas changer le monde à douze ans, mais on peut tenter de redonner espoir à son entourage : une mère déboussolée, un professeur solitaire et un SDF sont des cobayes de rêve pour un garçon inventif, généreux, en manque d''affection. ', 'Un Monde meilleur', 3),
(4, '2001', 'Une légende du crime contraint cinq malfrats à aller s''acquitter d''une tâche très périlleuse. Ceux qui survivent pourront se partager un butin de 91 millions de dollars. ', 'Usual Suspects', 2),
(5, '1995', 'John McClane est cette fois-ci aux prises avec un maître chanteur, facétieux et dangereux, qui dépose des bombes dans New York. ', 'Une journée en enfer', 4),
(6, '1994', 'L''odyssée sanglante et burlesque de petits malfrats dans la jungle de Hollywood à travers trois histoires qui s''entremêlent.', 'Pulp Fiction', 2);
