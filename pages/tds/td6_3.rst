...
.. step::
    ...
    .. warning::
        ...
        Vous devrez commenter cette ligne après avoir fini la génération. Cette
        solution est un contournement en attendant que le code du générateur ait
        été adapté à Symfony Flex.
